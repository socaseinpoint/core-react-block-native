...
```javascript
import Onboard from 'web3-onboardcore-scsnpnt'
...
:root {
  ...
  --onboard-font-size-1: 3em;
  --onboard-font-size-2: 2.25em;
  --onboard-font-size-3: 1.5em;
  --onboard-font-size-4: 1.25em;
  --onboard-font-size-5: 1em;
  --onboard-font-size-6: 0.875em;
  --onboard-font-size-7: 0.75em;

  /* SPACING */
  --onboard-spacing-1: 3em;
  --onboard-spacing-2: 2em;
  --onboard-spacing-3: 1.5em;
  --onboard-spacing-4: 1em;
  --onboard-spacing-5: 0.5em;
  ...
  --account-select-modal-font-size-5: 1em;
  --account-select-modal-font-size-7: .75em;
  --account-select-modal-font-line-height-1: 24px;

  /* SPACING */
  --account-select-modal-margin-4: 1em;
  --account-select-modal-margin-5: 0.5em;
